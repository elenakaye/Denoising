...
class denoiser(object):
    ...
    def evaluate(self,
        ...
        for idx in xrange(len(test_data)):
            ...
            # we need to change the image inputs to get a pair clean and noisy image
            # that we can run through this
            ...
            output_clean_image, psnr_summary = self.sess.run(
                ...
                feed_dict={self.Y_: clean_image,
                           self.X: noisy_image, # TODO modify to make it work. Right now is not reading this
            ...
            save_images(os.path.join(sample_dir, 'test%d_%d.png' % (idx + 1, iter_num)),
                        groundtruth, noisyimage, noisy_image-outputimage)
