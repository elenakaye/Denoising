...
def denoiser_train(denoiser, lr):
    with load_data(filepath='./data/img_clean_pats.npy') as data:
        with load_data(filepath='./data/img_target_pats.npy') as target_data:
            ...
            #eval_files = glob('./data/test/{}/*.png'.format(args.eval_set)) # previous data was in a folder
            eval_files = glob('./data/test/*.png')
            ...
            eval_target_files = glob('./data/TargetMRI/*.png')
